...
// Manual registration kept in sync until the generator runs again.
...
const EmergencyContactsRoute = EmergencyContactsRouteImport.update({ id: '/contacts', path: '/contacts', getParentRoute: () => EmergencyRoute } as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/emergency/contacts': { id: '/emergency/contacts'; path: '/contacts'; fullPath: '/emergency/contacts'; preLoaderRoute: typeof EmergencyContactsRouteImport; parentRoute: typeof EmergencyRoute }
...
interface EmergencyRouteChildren { EmergencyContactRoute: typeof EmergencyContactRoute; EmergencyContactsRoute: typeof EmergencyContactsRoute }
const EmergencyRouteChildren: EmergencyRouteChildren = { EmergencyContactRoute, EmergencyContactsRoute }
const EmergencyRouteWithChildren = EmergencyRoute._addFileChildren(EmergencyRouteChildren)
interface HostEventRouteChildren { HostEventDetailsRoute: typeof HostEventDetailsRoute }
const HostEventRouteChildren: HostEventRouteChildren = { HostEventDetailsRoute }
const HostEventRouteWithChildren = HostEventRoute._addFileChildren(HostEventRouteChildren)
const rootRouteChildren: RootRouteChildren = {
  IndexRoute, BookACabRoute, CommunityRoute, EmergencyRoute: EmergencyRouteWithChildren, HealthyFoodRoute,
  HostEventRoute: HostEventRouteWithChildren, LoginRoute, NearMeRoute, NotificationsRoute, ProfileRoute,
  ResetPasswordRoute, SetupRoute, SignupRoute,
}
