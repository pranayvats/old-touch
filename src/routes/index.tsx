...
import { AlertTriangle, CalendarPlus, CarTaxiFront, Salad, Users, MapPin } from "lucide-react";
...
function HomeScreen() {
  return <AppShell><header className="px-5 pb-2 pt-8"><h1 className="text-4xl font-black tracking-tight text-foreground">Old Touch</h1><p className="mt-1 text-lg font-semibold text-muted-foreground">Namaste! What would you like to do?</p></header><main className="flex flex-col gap-4 p-5">
